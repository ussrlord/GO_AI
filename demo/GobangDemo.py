...
def negativeMax(is_ai, depth, alpha, beta):
	if is_game_over(ai_list) or is_game_over(me_list) or depth == 0:
...
# 画棋盘
def initTab():
	gw = GraphWin('AI Go Test', GRID_WIDTH*COLUMN, GRID_WIDTH*ROW)
	gw.setBackground('#554E44')#054E9F
