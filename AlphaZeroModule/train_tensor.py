...
from AlphaZeroModule.policy_value_net_tensorflow import PolicyValueNet  # Theano and Lasagne
from AlphaZeroModule.constants import *

class TrainPipeline():
    def __init__(self, init_model=None):
        # params of the board and the game
        self.board_width = CONSTANT_GO_BOARD_WIDTH
        self.board_height = CONSTANT_GO_BOARD_HEIGHT
        self.n_in_row = 4
